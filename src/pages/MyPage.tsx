...
import MyThreadCard from "@/components/ui/MyThread";
    ...
    return (
        <HomeLayout>
            ...
            <div className="min-h-screen text-white flex flex-col items-center py-10 px-6">
                <div className="w-full max-w-2xl bg-zinc-900 rounded-xl overflow-hidden mb-3">
                    ...
                    <div className="absolute -top-10 left-4">
                        ...
                        src={
                            ...
                            ? `${baseUrl}/uploads/${profile.photoProfile}`
                            : "/default.jpg"
                        }
                        alt="profile"
